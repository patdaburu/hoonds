...
# -*- coding: utf-8 -*-
#
# hoonds documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'hoonds.tex', 'hoonds Documentation',
     'Pat Daburu', 'manual'),
]
...
man_pages = [
    (master_doc, 'hoonds', 'hoonds Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'hoonds', 'hoonds Documentation',
     author, 'hoonds', 'One line description of project.',
     'Miscellaneous'),
]
